...
For more discussion, see [Discussion: Balance]

## Phase Definitions

| Phase | Frontier Image | Software Stance | Ship-able code |
|-------|----------------|----------------|------|
| **Exploring** | Scout mapping rivers & passes | Throw-away spikes, REPL experiments, “what if?” scripts | None |
| **Pioneering** | Lone family clearing a homestead | Minimal end-to-end script on toy data | None |
| **Settling** | Cluster of families + shared barn/mill | Usable core APIs, persistence, integration tests | probably not |
| **Fortifying** | Fort for defense, stores and other services, docks and rail stations | configurable, logging, error management, functionally complete   | Yes |
...
For more a more detailed discussion, see [A Story]
